...
public class SpoofCookieAssignment extends AssignmentEndpoint {
    ...
    static final String LOGIN_CONTEXT_PATH = "/SpoofCookie/login";
    static final String ERASE_COOKIE_CONTEXT_PATH = "/SpoofCookie/cleanup";

    @PostMapping(path = LOGIN_CONTEXT_PATH)
    @ResponseBody
    ...
    @GetMapping(path = ERASE_COOKIE_CONTEXT_PATH)
